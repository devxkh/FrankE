...
namespace VEX.Core.Shared.Model.Scene.Objects.ChildObject.Animation
{
    ...
    public class MixNode : AnimNode, IFBObject
    {
        #region Properties 
        ...
        public FBNetData CreateFBData(FlatBufferBuilder fbbParent = null, IFBObject child = null)
        {
            ...
            XFBType.MixNode.StartMixNode(fbbParent);
          //  XFBType.MixNode.AddId(fbbParent, Id);
            XFBType.MixNode.AddSize(fbbParent, Size);
            var paremterNodeOffset = XFBType.MixNode.EndMixNode(fbbParent);
