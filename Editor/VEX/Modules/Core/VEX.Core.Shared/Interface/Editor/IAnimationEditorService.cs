...
namespace VEX.Interface.UI
{
    ...
    /// </summary>
    public interface IAnimationEditorService
    {
        ...
        ObservableCollection<AnimationEditorModel> AnimationEditors { get; }
     ...
     //   TreeList TreeList { get; set; }
      ...
      //  void SetAsRoot(IScene scene);
        ...
        bool AddAnimationEditor(AnimationEditorModel scene);
       ...
       // bool SetCurrent(Guid guid);
        ...
        AnimationEditorModel SelectedAnimationEditor { get; set; }
