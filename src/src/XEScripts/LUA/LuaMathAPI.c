...
/* get function: defined_ of class  BoundingBox */
#ifndef TOLUA_DISABLE_tolua_get_BoundingBox_defined
static int tolua_get_BoundingBox_defined(lua_State* tolua_S)
{
  BoundingBox* self = (BoundingBox*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'defined_'",NULL);
#endif
 tolua_pushboolean(tolua_S,(bool)self->defined_);
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: defined_ of class  BoundingBox */
#ifndef TOLUA_DISABLE_tolua_set_BoundingBox_defined
static int tolua_set_BoundingBox_defined(lua_State* tolua_S)
{
  BoundingBox* self = (BoundingBox*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 ...
 tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->defined_ = ((bool)  tolua_toboolean(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
/* get function: defined_ of class  Sphere */
#ifndef TOLUA_DISABLE_tolua_get_Sphere_defined
static int tolua_get_Sphere_defined(lua_State* tolua_S)
{
  Sphere* self = (Sphere*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'defined_'",NULL);
...
/* set function: defined_ of class  Sphere */
#ifndef TOLUA_DISABLE_tolua_set_Sphere_defined
static int tolua_set_Sphere_defined(lua_State* tolua_S)
{
  Sphere* self = (Sphere*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
...
static int tolua_MathLuaAPI_StringHash_new03(lua_State* tolua_S)
{
 ...
 {
  const String str = ((const String)  tolua_tourho3dstring(tolua_S,2,0));
 {
...
/* method: operator/ of class  Vector2 */
#ifndef TOLUA_DISABLE_tolua_MathLuaAPI_Vector2__div02
static int tolua_MathLuaAPI_Vector2__div02(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
 !tolua_isusertype(tolua_S,1,"const Vector2",0,&tolua_err) ||
 ...
 return 1;
tolua_lerror:
 return tolua_MathLuaAPI_Vector2__div01(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_MathLuaAPI_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,"BoundingBox");
  ...
  tolua_variable(tolua_S,"defined",tolua_get_BoundingBox_defined,tolua_set_BoundingBox_defined);
 ...
 tolua_beginmodule(tolua_S,"Sphere");
  ...
  tolua_variable(tolua_S,"defined",tolua_get_Sphere_defined,tolua_set_Sphere_defined);
 tolua_endmodule(tolua_S);
 #ifdef __cplusplus
 ...
 tolua_beginmodule(tolua_S,"Vector2");
  ...
  tolua_function(tolua_S,".div",tolua_MathLuaAPI_Vector2__div02);
