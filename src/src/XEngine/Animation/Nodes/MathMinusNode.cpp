...
Port* MathMinusNode::getAPort()
{
	return m_aPort;
}

const Port* MathMinusNode::getAPort() const
{
	return m_aPort;
}

Port* MathMinusNode::getBPort()
{
	return m_bPort;
}

const Port* MathMinusNode::getBPort() const
{
	return m_bPort;
}

float MathMinusNode::evaluateValue(double deltaTime)
{
