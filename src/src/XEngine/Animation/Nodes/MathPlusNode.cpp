...
Port* MathPlusNode::getAPort()
{
	return m_aPort;
}

const Port* MathPlusNode::getAPort() const
{
	return m_aPort;
}

Port* MathPlusNode::getBPort()
{
	return m_bPort;
}

const Port* MathPlusNode::getBPort() const
{
	return m_bPort;
}

float MathPlusNode::evaluateValue(double deltaTime)
{
