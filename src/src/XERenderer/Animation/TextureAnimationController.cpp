...
//
//
//	void XETexCoordModifierControllerValue::scaleAnimation(bool scaleU, bool scaleV)
//	{
//		 mScaleU = scaleU;
//		 mScaleV = scaleV;
//	}
//
//	void XETexCoordModifierControllerValue::scrollAnimation(bool translateU, bool translateV)
//	{
//		mTransU = translateU;
//		mTransV = translateV;
//	}
//
//	void XETexCoordModifierControllerValue::rotationAnimation(bool rotate)
//	{
//		mRotate = rotate;
//	}
//
//	void XETexCoordModifierControllerValue::tiledAnimation(Ogre::uint16 numFramesHorizontal, Ogre::uint16 numFramesVertical)
//	{
