...
namespace Ogre {
	...
	//-----------------------------------------------------------------------
	TextureAnimationControllerValue::TextureAnimationControllerValue(Ogre::HlmsDatablock *datablock, Ogre::uint8 textureUnit)
	...
	//-----------------------------------------------------------------------
	Ogre::Real TextureAnimationControllerValue::getValue() const
	{
		if (mTransU)
		{
	...
	void TextureAnimationControllerValue::tiledAnimation(Ogre::uint16 numFramesHorizontal, Ogre::uint16 numFramesVertical)
	{
