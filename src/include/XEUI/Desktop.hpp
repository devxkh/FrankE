 ...
 */
class XE_API Desktop : public Container  {
	public:

		typedef std::shared_ptr<Desktop> Ptr; //!< Shared pointer.
		typedef std::shared_ptr<const Desktop> PtrConst; //!< Shared pointer.

	
		static Ptr Create(GUIRenderer& guiRenderer, CameraRenderable& camera, const XE::Uint16 atlasId);
...
//		void HandleSizeChange() override;
	...
	protected:
		Desktop(GUIRenderer& guiRenderer, CameraRenderable& camera, const XE::Uint16 atlasId);
