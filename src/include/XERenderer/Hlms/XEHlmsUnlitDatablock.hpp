...
//	typedef FastArray<UnlitBakedTexture> UnlitBakedTextureArray;
	...
	*/
	class _OgreHlmsUnlitExport XEHlmsUnlitDatablock : public HlmsDatablock, public ConstBufferPoolUser
	{
		friend class XEHlmsUnlit;
	public:
	...
	public:
		...
		*/
		XEHlmsUnlitDatablock(IdString name, XEHlmsUnlit *creator,
			const HlmsMacroblock *macroblock,
			const HlmsBlendblock *blendblock,
			const HlmsParamVec &params);
		virtual ~XEHlmsUnlitDatablock();
